...
val dictionary: List[Word] = List("a", "ba", "bb", "abb", "bab", "aba")
...
anagrams
val finalList = List(List(), List(), List(), List(List(List(('a',1), ('b',2)))))
//finalList.foldLeft(List(List(List())))((acc, list) => acc:::list)
finalList.reduce(_:::_)
finalList.foldLeft(List(): List[List[Occurrences]])(
  (B:List[List[Occurrences]], A:List[List[Occurrences]]) => B:::A)
val f2 = wordOccurrences("b")
